                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="visits"><g:message code="page.visits.label" default="Visits" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: pageInstance, field: 'visits', 'errors')}">
...
<g:link controller="visit" action="create" params="['page.id': pageInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'visit.label', default: 'Visit')])}</g:link>
