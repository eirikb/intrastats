  ...
  <div class="body">
    ...
    <div class="list">
      <table>
        ...
        <g:sortableColumn property="dateCreated" title="${message(code: 'visit.dateCreated.label', default: 'Created')}" />
        ...
        <th><g:message code="visit.referral.label" default="Referral" /></th>
        ...
        <g:each in="${visitInstanceList}" status="i" var="visitInstance">
          ...
          <td>${fieldValue(bean: visitInstance, field: "dateCreated")}</td>
